...
way out, giving identical numerics to the Triton twin. The arithmetic is the same as
...
128, K by 64 for the floor and 32 for the pipelined version) and do **no
...
memory, and async copies*; with all three, hand control climbs from 0.55× to
